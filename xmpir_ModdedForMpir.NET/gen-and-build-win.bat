...
@rem @SET VCVARS32PATH="C:\Program Files\Microsoft Visual Studio 12.0\VC\bin\vcvars32.bat"
@rem
@SET VCVARS64PATH="C:\Program Files (x86)\Microsoft Visual Studio 12.0\VC\bin\x86_amd64\vcvarsx86_amd64.bat"
@rem @SET VCVARS64PATH="C:\Program Files\Microsoft Visual Studio 12.0\VC\bin\x86_amd64\vcvarsx86_amd64.bat"
@rem
